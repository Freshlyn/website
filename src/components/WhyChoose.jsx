...
import imgRange from "../assets/why3_range.png";
import imgQuality from "../assets/why4_quality.jpg";
import imgTaste from "../assets/why5_taste.jpg";
import imgHome from "../assets/why6_home.png";

const reasons = [
  {
    img: imgFresh,
    title: "100% Fresh & Naturally Sourced",
    desc: "Organic, natural, and preservative-free food products — always.",
  },
  {
    img: imgFarm,
    title: "Farm to Home Delivery",
    desc: "Sourced directly from trusted farms and local producers.",
  },
  {
    img: imgRange,
    title: "Wide Product Range",
    desc: "Dairy, vegetables, rice, sweets and pantry — all in one place.",
  },
  {
    img: imgQuality,
    title: "Quality You Can Trust",
    desc: "Every batch goes through freshness and hygiene checks.",
  },
  {
    img: imgTaste,
    title: "Traditional Taste",
    desc: "Authentic flavors of Bengal with the ease of modern access.",
  },
  {
    img: imgHome,
    title: "Perfect for Every Home",
    desc: "Ideal for daily groceries, festive needs, and healthy living.",
  },
];

const idealFor = [
  "Daily family groceries",
      ...
      <div className="why-container">
        ...
        <div className="ideal-section">
          <div className="ideal-left">
            ...
            <p className="ideal-subtitle">
              FreshLyn is the go-to choice for families who value freshness,
              quality, and authenticity.
            </p>
            <a href="#products" className="pill-btn">
              Explore products →
            </a>
          </div>
