  ...
  return (
    <div className="tnc-wrapper">
      <header className="tnc-header">
        <Link to="/" className="tnc-back-link">← Back to Home</Link>
      ...
      <main className="tnc-container">
        ...
        <p className="tnc-intro">
          Welcome to Freshlyn Nature! These Terms and Conditions govern your use of our website, products,
          and services available at{' '}
          <a href="https://www.freshlynnature.com" target="_blank" rel="noopener noreferrer">
        ...
        <section className="tnc-section">
          ...
          <ul>
            <li><strong>"Company," "We," "Us," "Our"</strong> refer to Freshlyn Nature.</li>
            <li><strong>"User," "You," "Your"</strong> refer to any person accessing or using our website.</li>
            <li><strong>"Products"</strong> refer to all goods offered for sale through our website.</li>
            <li><strong>"Services"</strong> refer to all services provided by Freshlyn Nature.</li>
          </ul>
        </section>
        ...
        <section className="tnc-section">
          ...
          <p>
            Unless otherwise stated, all content on this website, including but not limited to text, images,
            graphics, logos, product descriptions, videos, and software, is the exclusive property of
            Freshlyn Nature and is protected by applicable intellectual property laws.
          </p>
          <p>You may not:</p>
          <ul>
            <li>Copy, reproduce, republish, or redistribute any material.</li>
            <li>Sell, rent, or sub-license any content.</li>
            <li>Use our trademarks, branding, or logos without prior written permission.</li>
          </ul>
        </section>
        ...
        <section className="tnc-section">
          ...
          <p>
            Freshlyn Nature offers natural, fresh, and premium-quality products. We strive to ensure that
            all product descriptions, images, pricing, and availability are accurate.
          </p>
        ...
        <section className="tnc-section">
          ...
          <p>
            All food, dairy, and consumable products sold by Freshlyn Nature are manufactured, processed,
            and packaged in accordance with applicable food safety standards, including FSSAI regulations.
          </p>
          ...
          <p>
            Freshlyn Nature shall not be liable for any damage, spoilage, or health issues arising from
            improper storage, mishandling, or use after delivery.
          </p>
        </section>
        ...
        <section className="tnc-section">
          ...
          <ul>
            ...
            <li>In case of pricing errors, we reserve the right to cancel the affected order.</li>
          </ul>
        </section>
        ...
        <section className="tnc-section">
          ...
          <ul>
            ...
            <li>
              Delays may occur due to unforeseen circumstances, including weather, transportation issues,
              or force majeure events.
            </li>
            <li>Ownership and risk transfer to the customer upon successful delivery.</li>
          </ul>
        </section>
        ...
        <section className="tnc-section">
          ...
          <p>
            Please refer to our separate Return and Refund Policy for detailed information regarding
        ...
        <section className="tnc-section">
          ...
          <ul>
            ...
            <li>The content is not defamatory, offensive, obscene, or misleading.</li>
          </ul>
          <p>
            We reserve the right to monitor, edit, or remove any content without prior notice. By posting
            content, you grant Freshlyn Nature a non-exclusive, royalty-free, perpetual, and worldwide
            license to use, reproduce, modify, and publish such content.
          </p>
        </section>
        ...
        <section className="tnc-section">
          ...
          <p>
            You may link to our website only in a fair and legal manner that does not damage our reputation
            or imply any association, approval, or endorsement without our written consent.
          </p>
        ...
        <section className="tnc-section">
          ...
          <p>
            Your use of this website is also governed by our Privacy Policy. Please review it carefully.
          </p>
        </section>
        ...
        <section className="tnc-section">
          ...
          <p>
            To the fullest extent permitted by law, Freshlyn Nature shall not be liable for any indirect,
        ...
        <section className="tnc-section">
          ...
          <p>
            You agree to indemnify and hold harmless Freshlyn Nature, its directors, employees, affiliates,
            and partners from any claims, liabilities, damages, losses, or expenses arising out of your
        ...
        <section className="tnc-section">
          ...
          <p>
            Freshlyn Nature shall not be held liable for any failure or delay in performance resulting from
            events beyond our reasonable control, including natural disasters, pandemics, strikes,
            transportation disruptions, or government actions.
          </p>
        </section>
        ...
        <section className="tnc-section">
          ...
          <address className="tnc-contact">
            <strong>Freshlyn Nature</strong><br />
            Kolkata, West Bengal, India<br />
            Email:{' '}
            <a href="mailto:info@freshlynnature.com">info@freshlynnature.com</a><br />
            Website:{' '}
            <a href="https://www.freshlynnature.com" target="_blank" rel="noopener noreferrer">
              https://www.freshlynnature.com
            </a>
